          ...
          >
            {contactMethods.map(({ icon: Icon, label, value, href, description }, i) => (
              <motion.a
                ...
                whileHover={{ x: 4 }}
                className="group flex items-start gap-4 bg-card rounded-xl border border-border p-5 hover:border-primary/30 hover:shadow-md transition-all duration-300 block"
              >

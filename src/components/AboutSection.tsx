      ...
      >
        {highlights.map(({ icon: Icon, label }, i) => (
          <motion.div
            ...
            className="flex items-center gap-2 px-5 py-2.5 rounded-full border border-border bg-card text-sm text-muted-foreground shadow-sm"
          >
      ...
      <div className="grid lg:grid-cols-2 gap-16 items-start">
        ...
        >
          <div className="relative group">
            ...
            <div className="w-72 md:w-80 aspect-[3/4] rounded-2xl overflow-hidden shadow-xl">
              <img
                src={founderImg}
            ...
            <div className="absolute -bottom-2 -right-2 w-16 h-16 border-b-2 border-r-2 border-primary/20 rounded-br-2xl" />
            <div className="absolute -top-2 -left-2 w-16 h-16 border-t-2 border-l-2 border-primary/20 rounded-tl-2xl" />
          </div>
